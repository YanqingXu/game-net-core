...
def main() -> None:
    ...
    for forbidden in (
        ...
        assert forbidden not in adapter_text, f"IOE-X6 scope escape: {forbidden}"
    ...
    require(
        ...
        "IOE-X1/X2/X3/X4/X5/X6 io_uring",
        platform_docs,
    )

    print("IOE-X1/X2/X3/X4/X5/X6 Engine, Pump, driver, Hub, capacity, and adapter contracts verified")
