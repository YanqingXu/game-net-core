...
def main() -> None:
    ...
    require(status_text, "latest recorded green Windows job is `ci` #26", migration_status)
    ...
    require(status_text, "Local Windows Debug long-soak evidence currently covers the previous", migration_status)
