...
def main() -> None:
    ...
    require(milestone_text, "passes 37/37 tests", milestone)
    ...
    require(migration_text, "37/37", migration_status)
    ...
    require(migration_text, "remote green status is established by ci #17 on main", migration_status)
