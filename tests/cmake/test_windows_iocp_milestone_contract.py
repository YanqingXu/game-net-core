...
def main() -> None:
    ...
    require(milestone_text, "Last checked: 2026-07-09", milestone)
    ...
    require(milestone_text, "passes 64/64 tests", milestone)
    ...
    require(migration_text, "64/64", migration_status)
    ...
    require(migration_text, "remote green status is established by ci #23 on main", migration_status)
