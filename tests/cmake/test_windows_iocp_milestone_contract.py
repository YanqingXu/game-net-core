...
def main() -> None:
    ...
    require(milestone_text, "`Poller::poll()` slot rejects use", milestone)
    require(milestone_text, "completion-to-Channel publisher, operation intrusive link", milestone)
    require(milestone_text, "Running -> Quiescing -> FinalDraining -> Shutdown", milestone)
