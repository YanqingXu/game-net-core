...
def main() -> None:
    ...
    linux_io_uring = step_block(
        ...
        "Build and test experimental IOE-X1–X10 io_uring",
    )
    require(linux_io_uring, "-DGAMENET_ENABLE_EXPERIMENTAL=ON")
    require(linux_io_uring, "--expected-total 136")
    require(linux_io_uring, "--expect-label experimental=7")
    ...
    linux_io_uring_asan = step_block(
        ...
        "Build and test experimental IOE-X1–X10 io_uring with ASan/UBSan",
    )
    ...
    require(linux_io_uring_asan, "--expected-total 136")
    require(linux_io_uring_asan, "--expect-label experimental=7")
