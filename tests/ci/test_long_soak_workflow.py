...
def main() -> None:
    ...
    require(inventory, "--expected-total 125", workflow)
    ...
    require(
        manifest,
        "python3 tools/verify_ctest_inventory.py --test-dir build-long-soak --expected-total 125",
        workflow,
    )
    ...
    require(self_hosted_ci, "--expected-total 125", workflow)
    require(self_hosted_ci, "inventory+=(--expect-label threading=98)", workflow)
    ...
    require(ci_docs_text, "98 threading-labeled tests", ci_docs)
