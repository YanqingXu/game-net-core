...
def main() -> None:
    ...
    require(inventory, "--expected-total 119", workflow)
    ...
    require(
        manifest,
        "python3 tools/verify_ctest_inventory.py --test-dir build-long-soak --expected-total 119",
        workflow,
    )
    ...
    require(self_hosted_ci, "--expected-total 119", workflow)
    require(self_hosted_ci, "inventory+=(--expect-label threading=92)", workflow)
    ...
    require(ci_docs_text, "92 threading-labeled tests", ci_docs)
