...
def main() -> None:
    ...
    require(inventory, "--expected-total 115", workflow)
    ...
    require(
        manifest,
        "python3 tools/verify_ctest_inventory.py --test-dir build-long-soak --expected-total 115",
        workflow,
    )
    ...
    require(self_hosted_ci, "--expected-total 115", workflow)
    require(self_hosted_ci, "inventory+=(--expect-label threading=88)", workflow)
