...
def main() -> None:
    ...
    require(workflow_text, "python3 tests/scope/test_intent_metadata.py", workflow)
    require(workflow_text, "python3 tests/cmake/test_core_benchmark_contract.py", workflow)
    require(workflow_text, "python3 tests/cmake/test_logger_thread_contract.py", workflow)
    require(workflow_text, "python3 tests/cmake/test_tcp_connection_thread_contract.py", workflow)
    require(workflow_text, "python3 tests/ci/test_core_benchmark_workflow.py", workflow)
