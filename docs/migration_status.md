...
| 3 | Split CMake targets and test structure | Present: `gamenet_core`, echo examples, unit/contract/integration test directories, and EventLoopThread/EventLoopThreadPool contract tests |
...
also registers focused EventLoopThread and EventLoopThreadPool contract tests.
Build and CTest verification could not be run in this environment because
