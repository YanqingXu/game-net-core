...
当前发布治理绑定的实现检查点：`68b444dd109562d3d69c2b377c3bec90dcd15779`。
重新冻结候选 `v0.3.0-rel-c1-refreeze-1` 替代
`v0.3.0-rel-c1-freeze@d3137f9298b47474ea96dc694d44c5c026710039`；这只记录
