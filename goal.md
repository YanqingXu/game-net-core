...
当前发布治理绑定的实现检查点：`3d54c086e92c858b66df7bb80179431ec2d24867`。
重新冻结候选 `v0.3.0-rel-c1-refreeze-4` 替代
`v0.3.0-rel-c1-refreeze-3@0a500826844cb4f9345572909a733cc2e52ce14c`；这只记录
